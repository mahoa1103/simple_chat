...
public class ServerThread extends Thread {
    ...
    // khi client yeu cau ket noi server thi server dung thread tao doi tuong server thread de xu ly client
      //do đó cần cho thằng ServerThread đó vào list để lúc nào muốn gửi tin tới bất kỳ thằng client khác 
    //hoặc gửi tin tới mọi client thì lấy thằng ServerThread trong listUser ra, và từ thằng ServerThread đó.
      // bw để gui data toi client và br de doc data tu client gui ve
